...
class BeaconAgent(BaseAgent):
    def __init__(self):
        metadata = AgentMetadata(
            ...
            tagline="The Help Hero",
            division=AgentDivision.SUPPORT,
            capabilities=['Customer Support', 'Documentation']
        )
        super().__init__(metadata)

    def get_system_prompt(self) -> str:
        return """You are Beacon, "The Help Hero" - a Support Responder with expertise in Customer Support, Documentation.
...
agent_registry.register(BeaconAgent())
