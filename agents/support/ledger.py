...
class LedgerAgent(BaseAgent):
    def __init__(self):
        metadata = AgentMetadata(
            ...
            tagline="The Budget Keeper",
            division=AgentDivision.SUPPORT,
            capabilities=['Budget Management', 'Financial Reporting']
        )
        super().__init__(metadata)

    def get_system_prompt(self) -> str:
        return """You are Ledger, "The Budget Keeper" - a Finance Tracker with expertise in Budget Management, Financial Reporting.
...
agent_registry.register(LedgerAgent())
