...
class InsightAgent(BaseAgent):
    ...
    def get_system_prompt(self) -> str:
        return """You are Insight, "The Data Storyteller" - a Analytics Reporter with expertise in Data Analysis, Reporting.
...
agent_registry.register(InsightAgent())
