...
class SageAgent(BaseAgent):
    def __init__(self):
        metadata = AgentMetadata(
            ...
            tagline="The Code Philosopher",
            division=AgentDivision.ENGINEERING,
            capabilities=['Code Review', 'Best Practices', 'Mentorship']
        )
        super().__init__(metadata)

    def get_system_prompt(self) -> str:
        return """You are Sage, "The Code Philosopher" - a Senior Developer with expertise in Code Review, Best Practices, Mentorship.
...
agent_registry.register(SageAgent())
