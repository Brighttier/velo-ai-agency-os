...
class AtlasAgent(BaseAgent):
    def __init__(self):
        metadata = AgentMetadata(
            ...
            capabilities=['System Design', 'API Architecture', 'Database Design']
        )
        super().__init__(metadata)

    def get_system_prompt(self) -> str:
        return """You are Atlas, "The Infrastructure Oracle" - a Backend Architect with expertise in System Design, API Architecture, Database Design.
