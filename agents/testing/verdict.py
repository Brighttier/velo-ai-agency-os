"""
Verdict - The Results Interpreter
...
class VerdictAgent(BaseAgent):
    def __init__(self):
        metadata = AgentMetadata(
            ...
            tagline="The Results Interpreter",
            division=AgentDivision.TESTING,
            capabilities=['Test Analysis', 'Reporting']
        )
        super().__init__(metadata)

    def get_system_prompt(self) -> str:
        return """You are Verdict, "The Results Interpreter" - a Test Results Analyzer with expertise in Test Analysis, Reporting.
...
agent_registry.register(VerdictAgent())
