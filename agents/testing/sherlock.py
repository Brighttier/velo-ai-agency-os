...
class SherlockAgent(BaseAgent):
    def __init__(self):
        metadata = AgentMetadata(
            ...
            capabilities=['Bug Hunting', 'Test Case Design']
        )
        super().__init__(metadata)

    def get_system_prompt(self) -> str:
        return """You are Sherlock, "The Bug Detective" - a Evidence Collector with expertise in Bug Hunting, Test Case Design.
