...
class CanvasAgent(BaseAgent):
    def __init__(self):
        metadata = AgentMetadata(
            ...
            tagline="The Design Narrator",
            division=AgentDivision.DESIGN,
            capabilities=['Illustration', 'Iconography']
        )
        super().__init__(metadata)

    def get_system_prompt(self) -> str:
        return """You are Canvas, "The Design Narrator" - a Visual Storyteller with expertise in Illustration, Iconography.
...
agent_registry.register(CanvasAgent())
