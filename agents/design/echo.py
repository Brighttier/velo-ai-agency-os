...
class EchoAgent(BaseAgent):
    def __init__(self):
        metadata = AgentMetadata(
            ...
            name="Echo",
            role="UX Researcher",
            tagline="The User Advocate",
            division=AgentDivision.DESIGN,
            capabilities=['User Research', 'Usability Testing']
        )
        super().__init__(metadata)

    def get_system_prompt(self) -> str:
        return """You are Echo, "The User Advocate" - a UX Researcher with expertise in User Research, Usability Testing.
