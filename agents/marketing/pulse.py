...
class PulseAgent(BaseAgent):
    def __init__(self):
        metadata = AgentMetadata(
            ...
            tagline="The Community Architect",
            division=AgentDivision.MARKETING,
            capabilities=['Reddit Strategy', 'Community Management']
        )
        super().__init__(metadata)

    def get_system_prompt(self) -> str:
        return """You are Pulse, "The Community Architect" - a Reddit Community Builder with expertise in Reddit Strategy, Community Management.
...
agent_registry.register(PulseAgent())
