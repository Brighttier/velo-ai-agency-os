    ...
    for i, step in enumerate(steps):
        ...
        if step["agent"] == "Oracle" and "Generating" in step["action"]:
            ...
            try:
                ...
                print(f"Error generating PRD with Vertex AI: {e}")
...
"""
        ...
        if step["agent"] == "Neuron":
            ...
            try:
                ...
                print(f"Error generating tasks with Vertex AI: {e}")
                # Fallback to template tasks
                sample_tasks = [
                    {"title": "Design Database Schema", "description": "Create entity relationship diagram and define database tables", "assigned_agent": "Atlas", "priority": "high", "dependencies": [], "estimated_hours": 8},
                    {"title": "Build User Authentication", "description": "Implement login, signup, and password reset functionality", "assigned_agent": "Pixel", "priority": "high", "dependencies": [], "estimated_hours": 12},
                    {"title": "Create API Endpoints", "description": "Build RESTful API endpoints for core features", "assigned_agent": "Byte", "priority": "high", "dependencies": ["Design Database Schema"], "estimated_hours": 16},
                    {"title": "Design UI Components", "description": "Create reusable UI components following design system", "assigned_agent": "Pixel", "priority": "medium", "dependencies": [], "estimated_hours": 10},
                    {"title": "Write Unit Tests", "description": "Add comprehensive test coverage for all modules", "assigned_agent": "Judge", "priority": "medium", "dependencies": ["Create API Endpoints"], "estimated_hours": 8},
                ]
...
async def run_task_execution(task_id: str, project_id: str, task: Dict[str, Any]):
    ...
    try:
        ...
        print(f"Error generating code with Vertex AI: {e}")
